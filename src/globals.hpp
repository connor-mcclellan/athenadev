...
enum {GRAD_P_ACCEL, GRAD_P_ESTIMATE, GRAV_ACCEL, RAD_ACCEL, NET_ACCEL, MDOT, EDOT, CSOUND, TRAD_OVER_TGAS, DIVFLX, SRCFLX, DIV_ER, SRC_ER, DIVFLX_ANG, DIV_ER_ANG, DIVFLX_LAB, SRCFLX_LAB, DIV_ER_LAB, SRC_ER_LAB, DIVFLX_ANG_LAB, DIV_ER_ANG_LAB, NUM_UOV};
}
